...
let logicUnpack = {//根据公司的业务逻辑将从服务器拿到的数据信息解包以便加载不同的模块
  ...
  updateConf: function () {
    ...
    aliasCourse.isMulti = aliasServerData.objCourseInfo.coursestyle != undefined
      ? (!!(((aliasServerData.objCourseInfo.coursestyle == 2) || (aliasServerData.objCourseInfo.coursestyle == 9)))) : (false);
    ...
    //根据客户端plugLog值更新日志插件是否显示的属性
    classConf.boardSet.showPlugLog = aliasBoardSet.PlugLog != undefined
      ? (aliasBoardSet.PlugLog == 'true') : (false);
