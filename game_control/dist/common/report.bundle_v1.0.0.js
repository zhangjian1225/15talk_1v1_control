 ...
 **/
var dataReport = {
    openSwitch: '0', //是否开启上报功能 1：开启 0：关闭
    classConf: '',
    ...
    tracking: {
        getTrackUrl: function () {
            ...
            return dataReport.getProtocol() + '//logservice.51talk.com/coursewareactionlog';
        },
        ...
        sendControllerInfo: function (type, obj) {
            ...
            console.log('c tracking sendControllerInfo------------------->%s', JSON.stringify(this.trackingInfo));
            if (dataReport.openSwitch == '1') {
                $.ajax({
                    type: 'post',
                    url: trackingUrl,
